/**
 */
package org.xtext.project.tdsl.transfoDsl.util;
 ...
 * @generated
 */
public class TransfoDslAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected static TransfoDslPackage modelPackage;
   ...
   * @generated
   */
  public TransfoDslAdapterFactory()
  {
    if (modelPackage == null)
    {
      modelPackage = TransfoDslPackage.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected TransfoDslSwitch<Adapter> modelSwitch =
    new TransfoDslSwitch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.project.tdsl.transfoDsl.Transformation <em>Transformation</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.project.tdsl.transfoDsl.Layer <em>Layer</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.project.tdsl.transfoDsl.TrgMetamodel <em>Trg Metamodel</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
